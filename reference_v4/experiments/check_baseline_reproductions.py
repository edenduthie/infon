...
# Default paths
_DEFAULT_SCIFACT_DIR = str(REPO_ROOT / "reference_v4" / "experiments" / "data" / "scifact")
_DEFAULT_AVERITEC_DIR = str(REPO_ROOT / "reference_v4" / "experiments" / "data" / "averitec")
_DEFAULT_LLM_CACHE = str(REPO_ROOT / "reference_v4" / "experiments" / "results" / "llm_cache.jsonl")
