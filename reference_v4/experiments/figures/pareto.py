"""
pareto.py — Aggregate panel figure (reference_v4 wrapper).
...
Usage:
    python3 reference_v4/experiments/figures/pareto.py \
        --input reference_v4/experiments/results/aggregate_panel.json \
        --output reference_v4/experiments/figures/pareto.pdf
"""
