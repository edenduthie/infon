"""
reliability_diagrams.py — H3 panel figure (reference_v4 wrapper).
...
Usage:
    python3 reference_v4/experiments/figures/reliability_diagrams.py \
        --input reference_v4/experiments/results/h3_panel.json \
        --output reference_v4/experiments/figures/reliability_diagrams.pdf
"""
