"""
theta_distribution.py — H2 panel figure (reference_v4 wrapper).
...
Usage:
    python3 reference_v4/experiments/figures/theta_distribution.py \
        --input reference_v4/experiments/results/h2_panel.json \
        --output reference_v4/experiments/figures/theta_distribution.pdf
"""
