...
Usage:
    python3 reference_v4/experiments/benchmark_eval.py \
        --datasets hover averitec scifact \
        --systems cognition_symbolic cognition_gnn flat_retrieval symbolic_floor nli_classifier llm_zeroshot \
        --seeds 0 1 2 \
        --results-dir reference_v4/experiments/results \
        --llm-cache reference_v4/experiments/results/llm_cache.jsonl \
...
def main() -> None:
    ...
    parser.add_argument(
        "--systems", nargs="+",
        default=["cognition_symbolic", "cognition_gnn", "flat_retrieval",
    ...
    parser.add_argument(
        "--results-dir", default="reference_v4/experiments/results",
        help="Root directory for result files.",
    )
    parser.add_argument(
        "--llm-cache", default="reference_v4/experiments/results/llm_cache.jsonl",
