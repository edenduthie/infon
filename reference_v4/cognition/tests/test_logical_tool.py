...
def test_validate_rejects_bad_exprs():
    from cognition.logical_tool import validate, LogicalExprError
...
def test_validate_accepts_good_exprs():
    from cognition.logical_tool import validate
...
def test_evaluate_logic_agent_tool():
    ...
    create_tools(...)."""
    from cognition.agent_tools import create_tools, evaluate_logic
