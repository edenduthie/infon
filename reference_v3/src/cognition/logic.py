...
class HypergraphReasoner(nn.Module):
    ...
    def __init__(self, store, encoder, schema,
        ...
        self.ds_source_weights = LearnedDempsterWeights(num_sources=4)
    ...
    def train_source_weights(self,
        ...
        for iid in infon_ids:
            ...
            # Stack sources into a (4, 4) tensor: rows = sources, cols = {S,R,U,θ}
        ...
        S = torch.stack(source_tensors)  # (n_infons, 4, 4)
