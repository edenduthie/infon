"""
accuracy_by_hop.py — H1 panel figure (infon wrapper).
...
Usage:
    python3 experiments/figures/accuracy_by_hop.py \
        --input experiments/results/h1_panel.json \
        --output experiments/figures/accuracy_by_hop.pdf
"""
