...
Key insight: infon's NEXT edges (hyperedges linking infons through shared
...
explicit document linking — infon has them as first-class graph structure.
...
@dataclass
class HoVerResult:
    """Result for a single HoVer claim under infon evaluation."""
    claim_id: str
    claim: str
    gold_label: str
...
class CognitionHoVerRunner:
    """Run infon system on HoVer claims with hyperedge traversal.
