"""InfonSystem: fact-checking via the InfonStore pipeline.
...
def _verdict_to_mass(verdict) -> MassFunction:
    """Convert an infon Verdict into the benchmark MassFunction.
...
class InfonSystem:
    ...
    def _ask_claim(self, store: InfonStore, schema: dict, claim: EvalClaim):
        ...
        from infon.cassette.reason import Verdict as _Verdict
