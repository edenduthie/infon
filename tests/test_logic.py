...
def test_ingest_and_build_graph():
    ...
    with tempfile.TemporaryDirectory() as tmpdir:
        ...
        # Build hypergraph
        from infon.logic import HypergraphBuilder
...
def test_message_passing():
    ...
    import torch
    from infon.logic import HypergraphBuilder, TypedMessagePassingLayer
...
def test_reasoner_end_to_end():
    ...
    from infon.logic import HypergraphReasoner, HypergraphBuilder
...
def test_subgraph_pool():
    ...
    import torch
    from infon.logic import SubgraphPool
...
def test_causal_view():
    ...
    from infon.logic import HypergraphReasoner, CausalView
...
def test_confounder_detection():
    ...
    with tempfile.TemporaryDirectory() as tmpdir:
        ...
        from infon.logic import HyperGraph as _HG, REL_TO_IDX as _REL
