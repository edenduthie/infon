"""CLI entry point — launches the Infon TUI."""
...
def main():
    ...
    # Import inline to avoid heavy deps on `infon --help`
    try:
    ...
    import argparse
    parser = argparse.ArgumentParser(prog="infon", description="Infon TUI")
    parser.add_argument("--schema", help="Path to schema JSON file")
    parser.add_argument("--db", default="data/infon_mc.db", help="SQLite database path")
