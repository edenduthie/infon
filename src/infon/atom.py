...
class Infon:
    ...
    # Epistemic metadata (populated by extract_metadata.py)
    evidentiality: str = "assertion"   # assertion | hedge | attribution
    modality: str = "certain"          # certain | possible | obligation
