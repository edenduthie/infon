...
def _require_boto3():
    try:
        ...
        raise ImportError(
            "CloudCompute requires boto3. Install with: pip install infon[aws]"
        )
...
class CloudCompute:
    ...
    def submit(self, fn: Callable, *args, **kwargs):
        ...
        job_id = uuid.uuid4().hex[:8]
        key = f"infon/jobs/{job_id}/input.pkl"
        result_key = f"infon/jobs/{job_id}/output.pkl"
