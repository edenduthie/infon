#!/usr/bin/env python3
"""ask.py — Query an infon knowledge graph from the command line.
...
def main():
    parser = argparse.ArgumentParser(description="Query an infon knowledge graph")
