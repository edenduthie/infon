...
Cognition is built from four layers that compose without coupling: a cassette
...
property values).  Cognition infers this automatically: a predicate is treated
