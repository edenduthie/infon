...
We have presented Infon, a deployable knowledge-graph reasoner for
...
between Infon+GNN (66.0\%) and flat retrieval (42.0\%), supporting the
...
$m(\Theta)$ of 0.90 on NEI claims for Infon+GNN versus 0.60 for LLM
...
baseline (3\% vs.\ 24\%).  H3 shows Infon+GNN's ECE of 0.05 versus the
