...
\begin{enumerate}
  ...
  \item \textbf{Schema-free operation.}  Plain-English questions are encoded
    with the \texttt{rasyosef/splade-tiny} model~\cite{alemneh2025spladetiny}
    (17~MB, 4.4M parameters, non-commercial research licence, no GPU) to an
    anchor vocabulary. Connective predicates are auto-inferred from the
