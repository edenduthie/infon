...
The \texttt{rasyosef/splade-tiny} encoder~\cite{alemneh2025spladetiny}
is pre-trained on Microsoft's MS-MARCO passage corpus and used frozen;
its weights are not modified during any stage of Infon's training or
evaluation pipeline.  Both the upstream model and MS-MARCO are
distributed for non-commercial research use only --- commercial users
of Infon should review the model card and dataset terms before
deployment.  No personal or proprietary data is used in any component
of the system.
