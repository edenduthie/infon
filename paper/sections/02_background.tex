...
called the \emph{frame of discernment}.  Cognition uses
\[
  \Omega = \{S,\, R,\, U\},
\]
...
\paragraph{Four-part mass in Cognition.}
...
Cognition's unit of extracted knowledge is the \emph{infon}, drawn from
...
stream, and an extraction \emph{timestamp}.  This grounding lets Cognition cite
...
\paragraph{SPLADE-tiny in Cognition.}
Cognition uses the \texttt{naver/splade-v3-lexical} distilled variant
...
\paragraph{Use in Cognition.}
Cognition's 140k-parameter sheaf GNN (\texttt{SheafHypergraphEncoder}) uses
...
produces a logit over $\{S, R, U, \Theta\}$ that serves as the MCTS terminal
